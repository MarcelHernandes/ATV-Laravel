<x-layout titulo="Editar Carrinho">
    <form action="../atualizarCarrinho/{{$dado->id}}" method="get">
        <label>Id </label>
        <input type="number" id="number" value="{{$dado->id}}" disabled require/>
        <br><br>
        ...
        <input type="text" id="decricao" name="descricao" value="{{$dado->descricao}}" required/>
        <br><br>
